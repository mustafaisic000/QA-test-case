...
def test_incorrect_search(driver):
    ...
    search_field.click()
    search_field.clear()
    search_field.send_keys("kolicaaa")
    search_button = driver.find_element(By.CLASS_NAME, "ec-search")
    search_button.click()
    
    trazeni_rezultat_text_element_touple=(By.XPATH, "//h1[@class='lead-title text-center nemaartikala']")
    ...
    assert trazeni_rezultat == "Nema artikala za prikaz"
